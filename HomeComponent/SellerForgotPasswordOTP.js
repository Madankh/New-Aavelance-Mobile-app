...
export default function SellerForgotPasswordOTP() {
  ...
  const allinone = {pin1 , pin2 , pin3 , pin4};
    ...
    <View style={{backgroundColor:'black' , height:"100%"}}>
      ...
      <View style={{alignItems:"center" , marginTop:190}}>
        ...
        <View style={{flexDirection:'row' , marginTop:15 , marginLeft:20 }}>
          <TextInput maxLength={1} keyboardType="number-pad" ref={pin1Ref} onChangeText={(value)=>{
            setpin1(value)
            if(pin1Ref !== null){
          ...
          <TextInput ref={pin2Ref} maxLength={1} keyboardType="number-pad" onChangeText={(value)=>{ 
            setpin2(value)
            if(pin2 !==null){
              pin3Ref.current.focus()
            }
          }} style={{backgroundColor:"white" , marginRight:20 , width:46 , borderRadius:7 , fontSize:20 , textAlign:"center" }}/>
          <TextInput ref={pin3Ref} maxLength={1} keyboardType="number-pad" onChangeText={(value)=>{
            setpin3(value)
            if(pin3Ref !== null){
              pin4Ref.current.focus()
            }
            }} style={{backgroundColor:"white" , marginRight:20 , width:46 , borderRadius:7, fontSize:20 , textAlign:"center" }}/>
          <TextInput ref={pin4Ref} maxLength={1} keyboardType="number-pad" onChangeText={(value)=>{setpin4(value)}} style={{backgroundColor:"white" , marginRight:20 , width:46 , borderRadius:7, fontSize:20 , textAlign:"center" }}/>
        </View>
        <View>
