...
useEffect(() => {
  if(user.currentUser != null || user.currentUser != undefined ){
    navigation.navigate(navigationStrings.Home , user ) 
  }else{
    console.log("Error")
  }
    ...
    <View style={styles.mainView}>
      ...
      <View style={styles.BottomView}>
        ...
        <View style={styles.formView}>
          ...
          {error?.errors ? '':
                    <Text style={{color:'red' , marginTop:10}}>{user?.error}</Text>
          ...
          <TouchableOpacity onPress={() => navigation.navigate(navigationStrings.Forgotpassword)}>
            <Text style={{ color: '#fff', marginTop: 19, fontSize: 17, fontWeight: '400' }}>Forgot password</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.buttonlog} onPress={() => navigation.navigate(navigationStrings.Signup)}>
           <Text style={{color: 'black', fontSize: 18, fontWeight: '600'}}>Create new user account</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.buttonlog} onPress={() => navigation.navigate(navigationStrings.SellerSignin)}>
           <Text style={{color: 'black', fontSize: 18, fontWeight: '600'}}>Become a seller</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
